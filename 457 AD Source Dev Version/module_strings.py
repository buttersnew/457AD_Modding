...
("culture_roman", "Your people have a long ancestry, reaching back to the times of myths and legends, when the Gods played their tricks with the humans. Your people are descendants of Aeneas, who is a son of Venus. Thus the Gods gifted your people the right to rule over the world, the right to bring the light of civilisation in all corners of the world. Yet, the light is flickering and may go out. Now is a time, where Rome needs new heros."),
