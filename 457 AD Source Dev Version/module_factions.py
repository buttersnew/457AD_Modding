...
#madsci Spanish rebel factions, will be renamed automatically by a script depending on where they start
  ...
  ("minor_saraguroi","Saraguroi", 0, 0.9,[("outlaws",-0.75),("peasant_rebels", -0.1),("deserters", -0.05),("mountain_bandits", -0.05),("forest_bandits", -0.05),("berber_rebels", -0.05),("coptic_rebels", -0.05),("manhunters",0.6),("kingdom_23",-0.75),("minor_sabiroi",-0.75)], [], 0xc19135),
  ...
  ("adovacrius_host","Adovacrius_Host", 0, 0.9,[("kingdom_1",-0.75),("kingdom_3",-0.75),("kingdom_7",-0.75),("outlaws",-0.75)], [], 0xc19135),
