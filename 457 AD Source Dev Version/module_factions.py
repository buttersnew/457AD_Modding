...
# Factions before this point are hardwired into the game end their order should not be changed.
  ...
  ("kingdom_30",  "Framta's Suebi",  0, 0.9, [("saxons", -0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("berber_rebels", -0.05),("coptic_rebels", -0.05),("minor_gallaeci", -0.5)], [], 0xc9ad34),
