...
#multiplayer game type names
  ...
  ("lord_info_string", "{reg6?:{reg4?{s54} is the ruler of {s56}.^:{s54} is {reg5?the marshal for:a vassal of} {s55} of {s56}.^}}Renown: {reg15}. Controversy: {reg16}. Wealth: {reg17}.^Religion: {s29} ^{reg9?{reg3?She:He} is the {reg3?lady:lord} of {s58}.:{reg3?She:He} has no fiefs.}{s27}{s26}^{s59}^{s49}"),
  ("updating_faction_notes_for_s14_temp___reg4", "{!}Updating faction notes for {s14}, temp = {reg4}"),
  ...
  #("routed", "routed"),
  ("caravan_in_s10_considers_s11_total_price_dif___reg3", "{!}Caravan in {s10} considers {s11}, total price dif = {reg3}"),
  ...
  ("num_companion_stacks___reg10", "num companion stacks = {reg10}"),
  ("someone", "someone"),
...
##diplomacy end+
  ...
  ("s4_unassigned_centers_plus_landless_lords___reg4", "{!}{s4}: unassigned centers plus landless lords = {reg4}"),
...
##diplomacy end+
  ...
  ("combined_bonuses_and_penalties___reg0", "{!}Combined bonuses and penalties = {reg0}"),
  ...
  ("result_stalemate_patience_roll___reg3", "{!}Result: stalemate, patience roll = {reg3}"),
  ...
  ("envoymodified_diplomacy_score_honor_plus_relation_plus_envoy_persuasion___reg4", "{!}Envoy-modified diplomacy score (honor plus relation plus envoy persuasion) = {reg4}"),
...
#diplomacy end+
  ...
  ("__s3_price___reg4_calradian_average_reg6_capital_reg11_s4_base_reg1modified_by_raw_material_reg2modified_by_prosperity_reg3_calradian_average_production_base_reg5_total_reg12_consumed_reg7used_as_raw_material_reg8modified_total_reg9_calradian_consumption_base_reg10_total_reg13s1_", "{!}^^{s3}^Price = {reg4} (average {reg6})^Capital: {reg11} {s4}^Base {reg1}/modified by raw material {reg2}/modified by prosperity {reg3}^(average production, base {reg5}, total {reg12}).^Consumed {reg7}/used as raw material {reg8}/modified total {reg9}^(consumption, base: {reg10}, total: {reg13}){s1}^"),
...
##diplomacy end+
  ...
  ("giver_troop___s2", "{!}Giver troop = {s2}"),
  ...
  ("test_effective_relation___reg3", "{!}DEBUG : Effective relation = {reg3}"),
  ("g_talk_troop___reg0__g_encountered_party___reg1__slot_value___reg2", "{!}g talk troop = {reg0} , g encountered party = {reg1} , slot value = {reg2}"),
...
#  ("talk_is_for_heralds_and_lawyers_real_kings_prove_themselves_with_their_swords", "Talk is for heralds and lawyers. Real kings prove themselves with their swords."),
  ...
  ("me", "me"),
  ("preliminary_result_for_political___reg4", "{!}DEBUG : Preliminary result for political = {reg4}"),
  ...
  ("result_for_political___reg41", "{!}DEBUG : Result for political = {reg41}"),
  ...
  ("chance_of_success___reg1", "{!}DEBUG : Chance of success = {reg1}%"),
  ("random___reg3", "{!}DEBUG : Random = {reg3}"),
...
##diplomacy end+
  ...
  ("ERROR_lady_selected___s9", "{!}ERROR: lady selected = {s9}"),
