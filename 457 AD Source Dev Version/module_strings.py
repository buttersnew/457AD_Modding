...
#local color strings
  ...
  ("npc18_kingsupport_2b", "Chief, with no offense, but are you really sure of this?"), #Borcha
  ("npc19_kingsupport_2b", "On another, I don’t think it’s yet a time to do that."),
  ("npc20_kingsupport_2b", "No offense, but I'm not sure that's the approach I'd take"), #Borcha
  ...
  ("npc20_kingsupport_objection", "Unfished - you shouldn't see this."), #khaetag
...
#  ("npc13_intel_mission", "Oh valiant one! With your permission, I was thinking that I might pay a visit to the dales near {s17}. I try not to revisit old pastures, but I must confess a certain curiosity as to how a comely shepherdess of my former acquaintance is getting along. On the way, I may attempt to stop in at the castle. I suspect that it would not be terribly difficult for me to charm my way into the lord's hall, and I may be able to provide you with the latest news from the {s18}."), #nizar
  ...
  ("npc20_intel_mission", "Well, I will go to {s17}, land occupied by my kin. They will hear your stories and flock to you, Reiks."), #khaetag
  ...
  ("npc20_fief_acceptance", "You're giving me {s17} to rule over, Reiks? I never thought I'd ever have my own land. Thank you my Reiks!"), #khaetag
  ...
  ("npc18_woman_to_woman", "{!}."), #khaetag
  ("npc19_woman_to_woman", "{!}."), #khaetag
  ("npc20_woman_to_woman", "{!}."), #khaetag
...
("slot_production_sources_begin", "shouldn't be displayed"),
...
("culture_gothic", "You are a Goth, scion of Berig, the first king who left your ancestral homes in Scandza. Your people travelled long ways, through the dark forests and swamps of Eastern Europe in search of new fertile lands. Yet, the journey of your people hasn't stopped yet."),
("culture_eastgermanic", "You are a German of the East: for long time you wandered through the forests and steppes of Germania Scythica. Cruel lands, full of darkness and death. Now your people is turning West in search of fertile lands and wealth."),
...
("culture_pictish", "Your people rules the cold and rocky lands of the North. Your people used to the harsh environment, coldness and pain and look with contempt on your weak Southern neighbors."),
...
("culture_roman", "Your people have a long ancestry, reaching back to the times of myths and legends, when the Gods played their tricks with the humans. Your people are descendants of Aeneas, who is a son of Venus. Thus the Gods gifted your people the right to rule over the world, the right to bring the light of civilisation in all corners of the world. Yet, the light is flickers and may go out. Now is a time, where Rome needs new heros."),
...
("background_religion_coptic", "Your parents believed in Christos and in God, his powerful father. Christos preached equality and love. Yet, the Christians are quarreling about the correct understanging of Christos words and his nature. You and your parents follow the Coptic interpretation, which says that Christos is one nature from two natures: the Logos Incarnate. You never understood what this means, but you know that whatever the other Christian sects preach is wrong."),
