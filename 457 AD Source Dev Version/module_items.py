...
["oval_shield_tertiani", "Roman Oval Shield", [("oval_shield_2",0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_round_shield, 525 , weight(6.50)|hit_points(500)|body_armor(14)|spd_rtng(86)|shield_width(46)|shield_height(107),imodbits_shield, [(ti_on_init_item,[(cur_item_set_material, "str_oval_shields_west_4"),]),], culture_roman ],
["oval_shield_cortoriacenses", "Roman Oval Shield", [("oval_shield_1",0)], itp_merchandise|itp_type_shield|itp_cant_use_on_horseback|itp_wooden_parry, itcf_carry_round_shield, 525 , weight(6.50)|hit_points(520)|body_armor(14)|spd_rtng(86)|shield_width(46)|shield_height(107),imodbits_shield, [(ti_on_init_item,[(cur_item_set_material, "str_oval_shields_west_4"),]),], culture_roman ],
