...
#recruiter kit end
  ...
  ("heruli_party","Heruli Patrol",icon_axeman|carries_goods(30)|pf_show_faction,0,fac_minor_heruli,bandit_personality,[(trp_heruli_slave,10,30),(trp_heruli_warrior,10,20),(trp_heruli_horseman,5,10)]),
