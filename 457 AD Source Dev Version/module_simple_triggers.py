...
(this_or_next|faction_slot_eq, "fac_kingdom_4", slot_faction_state, sfs_defeated),
(neg|troop_slot_eq, "trp_kingdom_4_lord", slot_troop_occupation, slto_kingdom_hero),
(disable_party, "p_coalition_camp"),
(call_script, "script_cancel_quest", "qst_battle_of_bolia"),
(try_end),

(try_begin),
(check_quest_active, "qst_silingi_quest"),
(this_or_next|faction_slot_eq, "fac_kingdom_15", slot_faction_state, sfs_defeated),
(neg|troop_slot_eq, "trp_kingdom_15_lord", slot_troop_occupation, slto_kingdom_hero),
(disable_party, "p_silingi_village"),
(call_script, "script_cancel_quest", "qst_silingi_quest"),
(try_end),

(try_begin),
(check_quest_active, "qst_battle_of_garigliano"),
(this_or_next|faction_slot_eq, "fac_kingdom_1", slot_faction_state, sfs_defeated),
(neg|troop_slot_eq, "trp_kingdom_1_lord", slot_troop_occupation, slto_kingdom_hero),
(disable_party, "p_sinuessa"),
(call_script, "script_cancel_quest", "qst_battle_of_garigliano"),
(try_end),
  ...
  (1, [(neg|map_free),
	...
	(try_begin),
       ...
       (else_try), #Chance of revolt against player
         ...
         (try_end),
       (try_end),
(else_try), #madsci scavenging
  (ge, "$scavenging", 0),
  (eq, "$currently_scavenging", "$current_town"),
  (val_sub, "$scavenging", 1),
  (try_begin),
	(this_or_next|party_slot_eq, "$current_town", slot_village_state, svs_normal),
    	(lt, "$scavenging", 0),
    	(assign, "$scavenging", 0),
    	(rest_for_hours, 0, 0, 0),
    	(jump_to_menu, "mnu_scavenging_complete"),
  (try_end),
(else_try), #madsci blessing
       (ge, "$blessing", 0),
       (eq, "$currently_blessing", "$current_town"),
       (val_sub, "$blessing", 1),
	 ...
	 (this_or_next|party_slot_eq, "$current_town", slot_village_state, svs_normal),
         ...
         (assign, "$blessing", 0),
         (rest_for_hours, 0, 0, 0), #stop resting
         (jump_to_menu, "mnu_blessing_complete"),
       (try_end),
(else_try), #madsci preaching
       (ge, "$preaching", 0),
	...
	(store_random_in_range, ":collected_tax", 1, ":prosperity"),
	(val_div, ":collected_tax", 8),
	(val_add, ":collected_tax", ":skill"),
		(try_begin),
		...
		(val_div, ":collected_tax", 8),
		(else_try),
		(val_div, ":collected_tax", 4),
		(try_end),
	#(call_script, "script_troop_add_gold", "trp_player", ":collected_tax"),
	(assign, ":multiplier", 10),
	(val_add, ":multiplier", ":skill"),
	(val_mul, ":collected_tax", ":multiplier"),
	(gt, ":collected_tax", 0),	
	(assign, "$temp", ":collected_tax"),
	(jump_to_menu, "mnu_preaching_collected"),
       (try_end),
       (try_begin),
	(gt, "$preaching", 1),
	(troop_get_slot, ":religion_player","trp_player", slot_troop_religion),
        (party_get_slot, ":religion_center",  "$g_encountered_party", slot_center_religion),
	(neq, ":religion_player", ":religion_center"),
	(store_random_in_range, ":rng", 0, 30),
	(eq, ":rng", 1), #madsci trying to convert the settlements religion can be dangerous
	(jump_to_menu, "mnu_preaching_revolt_warning"),
       (else_try), #Chance of revolt against player
	(ge, "$preaching", 1),
	(troop_get_slot, ":religion_player","trp_player", slot_troop_religion),
        (party_get_slot, ":religion_center",  "$g_encountered_party", slot_center_religion),
	(neq, ":religion_player", ":religion_center"),
	(assign, ":rev_chance", 40),
	(store_skill_level, ":persuasion", "skl_persuasion", "trp_player"),
	(val_add, ":rev_chance", ":persuasion"),
	(store_random_in_range, ":rng", 0, ":rev_chance"),
         (try_begin),
           (eq, ":rng", 1),
           (jump_to_menu, "mnu_preaching_revolt"),
         (try_end),
       (try_end),
...
(try_end),
  ...
  (1,
	...
	(this_or_next|is_between, ":party_template", "pt_saraguroi_party", "pt_valentia_party"), #madsci let these guys raid villages too
	(this_or_next|eq, ":party_template", "pt_coptic_rebellion"),
	(this_or_next|eq, ":party_template", "pt_nero_rebel_army"),
	(this_or_next|eq, ":party_template", "pt_mauri_rebel_horde"),
        ...
        (try_begin),
          (this_or_next|eq, ":ai_bhvr", ai_bhvr_escort_party), #madsci do nothing if already doing something useful
	  ...
	  (else_try),
            ...
            (try_begin),
              ...
              (try_begin),
                ...
                (try_begin),
                  ...
                  (try_begin),
                    (call_script, "script_add_notification_menu", "mnu_notification_village_raid_started_party", ":p_target", ":party_no"),
                  (else_try),
        ...
        (else_try),
          ...
          (try_begin),
		(try_begin),
		(is_between, ":party_template", "pt_saraguroi_party", "pt_valentia_party"),
		(val_add, ":size", 15), #madsci steppe tribes are stronger
		(try_end),
            (ge, ":size", 50),
            (store_random_in_range, ":rand", 0, 1000),
		(try_begin),
		(eq, ":faction", "fac_deserters"),
		(assign, ":attack_chance", 25),
		(else_try),
		(assign, ":attack_chance", 5),
		(try_end),
              (lt, ":rand", ":attack_chance"),
              (assign, ":minimum_distance", 30),
              (assign, ":closest_village", -1),
              (try_for_range, ":village_no", villages_begin, villages_end),
		(store_faction_of_party, ":other_party_faction", ":village_no"),
		(neq, ":faction", ":other_party_faction"),
		(neg|faction_slot_eq, ":faction", slot_faction_tributary_of, ":other_party_faction"),
		(neg|faction_slot_eq, ":other_party_faction", slot_faction_tributary_of, ":faction"),
		(store_relation, ":relation", ":faction", ":other_party_faction"),
		(le, ":relation", 0),
		...
		(assign, ":base_center", -1),
			(try_begin),
			(is_between, ":party_template", "pt_saraguroi_party", "pt_valentia_party"),
				(try_for_range, ":home_center", "p_onoguroi_village", "p_alan_1_village"),
				(store_faction_of_party, ":home_center_faction", ":home_center"),
				(eq, ":home_center_faction", ":faction"),
				(assign, ":base_center", ":home_center"),
				(try_end),
			(else_try),
			(this_or_next|eq, ":party_template", "pt_tuldila_rebels"),
			(eq, ":party_template", "pt_nero_rebel_army"),
			(assign, ":base_center", "p_town_8"), #rome
			(else_try),
			(eq, ":party_template", "pt_mauri_rebel_horde"),
			(assign, ":base_center", "p_town_49"), #leptis magna
			(else_try),
			(eq, ":party_template", "pt_coptic_rebellion"),
			(assign, ":base_center", "p_town_21"), #alexandria
			(try_end),
		(gt, ":base_center", 0),
            	(party_set_ai_patrol_radius, ":party_no", 30),
            	(party_set_slot, ":party_no", slot_party_ai_state, spai_patrolling_around_center),
	...
	(try_begin), #madsci resting events
	(eq, "$g_infinite_camping", 0),
	...
	(assign, "$last_rest_event", ":rng"),
		...
		(eq, ":rng", 1),
			...
			(is_currently_night),
         		...
         		(jump_to_menu, "mnu_457_rest_christian_vigil"),
       			(else_try),
         		(this_or_next|eq, ":center_religion", slot_religion_zoroastrianism),
         		(eq, ":center_religion", slot_religion_zurvanism),
         		(jump_to_menu, "mnu_457_rest_sacred_fire"),
       			(else_try),
         		(this_or_next|eq, ":center_religion", slot_religion_paganism),
         		(eq, ":center_religion", slot_religion_roman_paganism),
  ...
  (96, #every 4 days - 25% chance of an event
	...
	(eq, ":rnd", 1),
      ...
      (try_begin),
        (ge, ":player_renown", 80),
        (gt, ":num_men", 30),
        (store_random_in_range, ":rand", 0, 54), #keeps the active-event chance near 50% after adding five events
        (try_begin),
          (eq, ":rand", 0),
	...
	(is_between, reg0, villages_begin, villages_end),
	(store_distance_to_party_from_party, ":dist", reg0, "p_main_party"),
	(lt, ":dist", 6),
	...
	(troops_can_join, 6), #madsci
        ...
        (else_try),
          (eq, ":rand", 19),
      	(call_script, "script_get_closest_center", "p_main_party"),
	(neg|is_between, reg0, castles_begin, castles_end),
	(store_distance_to_party_from_party, ":dist", reg0, "p_main_party"),
	(lt, ":dist", 6),
	...
	(gt, ":num_men", 50),
      	(call_script, "script_get_closest_center", "p_main_party"),
	(is_between, reg0, villages_begin, villages_end),
	(neg|party_slot_eq, reg0, slot_village_state, svs_looted),
	(neg|party_slot_eq, reg0, slot_village_state, svs_being_raided),
	(store_distance_to_party_from_party, ":dist", reg0, "p_main_party"),
	(lt, ":dist", 4),
	...
	(store_distance_to_party_from_party, ":dist", reg0, "p_main_party"),
	(lt, ":dist", 6),
        (store_faction_of_party, ":cur_faction", reg0),
        (this_or_next|eq, ":cur_faction", "$players_kingdom"),
	(eq, "$players_kingdom", 0),
...
(gt, ":anchor", 0),
	...
	(neq, ":icon", "icon_ship"),
	(store_random_in_range, ":rng", 0, 250), #dont let them move all the time, adjust this if necessary
	(eq, ":rng", 1),
...
(try_begin), #madsci flavor events go here
        (eq, "$g_infinite_camping", 0),
    	(eq, "$majorian_reforms", 0),
    	(eq, "$majorian_death", 0),
    	(gt, "$total_days_passed", 60),
    	(faction_slot_eq, "fac_kingdom_1", slot_faction_state, sfs_active),
    	(faction_slot_eq, "fac_kingdom_1", slot_faction_leader, "trp_kingdom_1_lord"),
    	(troop_slot_eq, "trp_kingdom_1_lord", slot_troop_occupation, slto_kingdom_hero),
	(store_faction_of_party, ":fac", "p_town_13"), #ravenna
	(eq, ":fac", "fac_kingdom_1"),
	(store_random_in_range, ":rnd", 0, 250),
	(eq, ":rnd", 1),
    	(assign, "$majorian_reforms", 1),
	(jump_to_menu, "mnu_majorian_reforms"),
(try_end),

(try_begin),
        (eq, "$g_infinite_camping", 0),
    	(eq, "$total_days_passed", 1),
	(this_or_next|eq, "$background_answer_5", "fac_culture_3"),
	(this_or_next|eq, "$background_answer_5", "fac_culture_5"),
	(this_or_next|eq, "$background_answer_5", "fac_culture_19"),
	(eq, "$players_kingdom", "fac_kingdom_13"),
	(jump_to_menu, "mnu_flavour_britain_after_rome"),
(try_end),
...
(try_begin), #madsci recurring barbarian problems for WRE
(this_or_next|eq, "$total_days_passed", 555),
#(this_or_next|eq, "$total_days_passed", 335),
(eq, "$total_days_passed", 99),
(faction_slot_eq, "fac_kingdom_1", slot_faction_state, sfs_active),
(faction_get_slot, ":tributary_cur", "fac_kingdom_1", slot_faction_tributary_of),
(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
(assign, ":attacks", 0),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_15", slot_faction_marshall, "trp_player"),
	(faction_slot_eq, "fac_kingdom_15", slot_faction_state, sfs_active),
	(faction_get_slot, ":tributary_cur", "fac_kingdom_15", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_1", "fac_kingdom_15"),
	(eq, ":reln", 0),
        	(try_begin),
		(faction_slot_eq, "fac_kingdom_3", slot_faction_state, sfs_active),
		(faction_get_slot, ":tributary_cur", "fac_kingdom_3", slot_faction_tributary_of),
		(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
		(neg|faction_slot_eq, "fac_kingdom_3", slot_faction_marshall, "trp_player"),
		(store_relation, ":relation", "fac_kingdom_3", "fac_kingdom_15"),
		(lt, ":relation", 0),
		(call_script, "script_diplomacy_start_peace_between_kingdoms", "fac_kingdom_3", "fac_kingdom_15", 1),
        	(try_end),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_15", "fac_kingdom_1", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_3", slot_faction_marshall, "trp_player"),
	...
	(eq, ":reln", 0),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_3", "fac_kingdom_1", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_7", slot_faction_marshall, "trp_player"),
	(faction_slot_eq, "fac_kingdom_7", slot_faction_state, sfs_active),
	(faction_get_slot, ":tributary_cur", "fac_kingdom_7", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_1", "fac_kingdom_7"),
	(eq, ":reln", 0),
	#(store_faction_of_party, ":party_faction", "p_town_15"), #lutetia
	#(eq, ":party_faction", "fac_kingdom_1"),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_7", "fac_kingdom_1", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_10", slot_faction_marshall, "trp_player"),
	(faction_slot_eq, "fac_kingdom_10", slot_faction_state, sfs_active),
	(faction_get_slot, ":tributary_cur", "fac_kingdom_10", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_1", "fac_kingdom_10"),
	(eq, ":reln", 0),
	#(store_faction_of_party, ":party_faction", "p_town_33"), #mediolanum
	#(eq, ":party_faction", "fac_kingdom_1"),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_10", "fac_kingdom_1", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_9", slot_faction_marshall, "trp_player"),
	(faction_slot_eq, "fac_kingdom_9", slot_faction_state, sfs_active),
	(faction_get_slot, ":tributary_cur", "fac_kingdom_9", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_1", "fac_kingdom_9"),
	(eq, ":reln", 0),
        	(try_begin),
		(faction_slot_eq, "fac_kingdom_3", slot_faction_state, sfs_active),
		(faction_get_slot, ":tributary_cur", "fac_kingdom_3", slot_faction_tributary_of),
		(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
		(neg|faction_slot_eq, "fac_kingdom_3", slot_faction_marshall, "trp_player"),
		(store_relation, ":relation", "fac_kingdom_3", "fac_kingdom_9"),
		(lt, ":relation", 0),
		(call_script, "script_diplomacy_start_peace_between_kingdoms", "fac_kingdom_3", "fac_kingdom_9", 1),
        	(try_end),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_9", "fac_kingdom_1", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(gt, ":attacks", 0),
	...
	(display_log_message, "@{s11} faces pressure as the Barbarians challenge Imperial authority."),
		(try_begin),
        	(eq, "$g_infinite_camping", 0),
		(jump_to_menu, "mnu_barbarian_attacks"),
		(try_end),
	(try_end),
(try_end),

(try_begin), #problems for ERE
#(this_or_next|eq, "$total_days_passed", 606),
#(this_or_next|eq, "$total_days_passed", 306),
(eq, "$total_days_passed", 266),
(faction_slot_eq, "fac_kingdom_2", slot_faction_state, sfs_active),
(faction_get_slot, ":tributary_cur", "fac_kingdom_2", slot_faction_tributary_of),
(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
(assign, ":attacks", 0),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_6", slot_faction_marshall, "trp_player"),
	(faction_slot_eq, "fac_kingdom_6", slot_faction_state, sfs_active),
	(faction_get_slot, ":tributary_cur", "fac_kingdom_6", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_2", "fac_kingdom_6"),
	(eq, ":reln", 0),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_6", "fac_kingdom_2", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_15", slot_faction_marshall, "trp_player"),
	...
	(faction_get_slot, ":tributary_cur", "fac_kingdom_15", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_2", "fac_kingdom_15"),
	(eq, ":reln", 0),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_15", "fac_kingdom_2", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_11", slot_faction_marshall, "trp_player"),
	(faction_slot_eq, "fac_kingdom_11", slot_faction_state, sfs_active),
	(faction_get_slot, ":tributary_cur", "fac_kingdom_11", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_2", "fac_kingdom_11"),
	(eq, ":reln", 0),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_11", "fac_kingdom_2", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_23", slot_faction_marshall, "trp_player"),
	(faction_slot_eq, "fac_kingdom_23", slot_faction_state, sfs_active),
	(faction_get_slot, ":tributary_cur", "fac_kingdom_23", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_2", "fac_kingdom_23"),
	(eq, ":reln", 0),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_23", "fac_kingdom_2", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(neg|faction_slot_eq, "fac_kingdom_33", slot_faction_marshall, "trp_player"),
	(faction_slot_eq, "fac_kingdom_33", slot_faction_state, sfs_active),
	(faction_get_slot, ":tributary_cur", "fac_kingdom_33", slot_faction_tributary_of),
	(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
	(store_relation, ":reln", "fac_kingdom_2", "fac_kingdom_33"),
	(eq, ":reln", 0),
        	(try_begin),
		(faction_slot_eq, "fac_kingdom_23", slot_faction_state, sfs_active),
		(faction_get_slot, ":tributary_cur", "fac_kingdom_23", slot_faction_tributary_of),
		(neg|is_between, ":tributary_cur", kingdoms_begin, kingdoms_end),
		(neg|faction_slot_eq, "fac_kingdom_23", slot_faction_marshall, "trp_player"),
		(store_relation, ":relation", "fac_kingdom_33", "fac_kingdom_23"),
		(lt, ":relation", 0),
		(call_script, "script_diplomacy_start_peace_between_kingdoms", "fac_kingdom_33", "fac_kingdom_23", 1),
        	(try_end),
	(call_script, "script_diplomacy_start_war_between_kingdoms", "fac_kingdom_33", "fac_kingdom_2", 0),
	(val_add, ":attacks", 1),
	(try_end),
	(try_begin),
	(gt, ":attacks", 0),
	...
	(str_store_troop_name_link, s11, ":faction_1_leader"),
	(display_log_message, "@{s11} faces pressure as enemies sense weakness and attack."),
		(try_begin),
        	(eq, "$g_infinite_camping", 0),
		(jump_to_menu, "mnu_barbarian_attacks_ere"),
		(try_end),
	(try_end),
(try_end),
]),
