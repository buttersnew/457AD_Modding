...
#        ]),
  ...
  ("flag_pole_new", 0, "sample_roman_spears_banner", 1024, 1024, 0, 0, 0, 0,
   [
       ...
       (cur_tableau_add_mesh, ":banner_mesh", pos1, 62, 0), #125 !!!
       (init_position, pos1),
       (position_set_z, pos1, 10),
...
#  ("oval_shield_3", 0, "curved_oval_shield_rom1", 1024, 1024, 0, 0, 0, 0,
 #  [
      # (store_script_param, ":banner_mesh", 1),
       ...
       #(init_position, pos1),
       #(position_set_x, pos1, -64.5),
       #(position_set_y, pos1, 73),
       #(cur_tableau_add_mesh, ":banner_mesh", pos1, 0, 0),
       #(init_position, pos1),
       #(position_set_z, pos1, 10),
       #(cur_tableau_add_mesh, "mesh_tableau_mesh_curved_oval_shield", pos1, 0, 0),
       #(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
      # ]),

 # ("oval_shield_4", 0, "curved_oval_shield_rom1_nm", 1024, 1024, 0, 0, 0, 0,
 #  [
  #     (store_script_param, ":banner_mesh", 1),
...
#       (init_position, pos1),
#       (position_set_z, pos1, 10),
#       (cur_tableau_add_mesh, "mesh_tableau_mesh_curved_oval_shield_2", pos1, 0, 0),
#       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
#       ]),

#  ("oval_shield_new", 0, "new_curved_oval_shield_1", 1024, 1024, 0, 0, 0, 0,
#   [
#       (store_script_param, ":banner_mesh", 1),
...
#       (cur_tableau_add_mesh, "mesh_tableau_mesh_new_curved_oval_shield", pos1, 0, 0),
#       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
#  ]),

#  ("oval_shield_new", 0, "juice_oval_shield_1", 1024, 1024, 0, 0, 0, 0,
#   [
#       (store_script_param, ":banner_mesh", 1),
...
#
#       (init_position, pos1),
#       (position_set_x, pos1, -50.2),
#       (position_set_y, pos1, 91),
#       (cur_tableau_add_mesh, ":banner_mesh", pos1, 111, 0),
#       (init_position, pos1),
#       (position_set_z, pos1, 20),
#       (cur_tableau_add_mesh, "mesh_tableau_mesh_new_curved_oval_shield", pos1, 0, 0),
#       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
...
#  ("oval_shield_device", 0, "juice_oval_shield_1", 512, 512, 0, 0, 0, 0,
#   [
#    (store_script_param, ":banner_mesh", 1),
#    (set_fixed_point_multiplier, 100),
...
#    (val_add, ":banner_mesh", "mesh_tableau_mesh_new_curved_oval_shield"),
#    (assign, reg3, ":banner_mesh"),
#    (cur_tableau_add_mesh, ":banner_mesh", pos1, 0, 0),
#    (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
#  ]),

  #("sclavenia_round_shield", 0, "sclavenia_round_shield_tab_2_sample", 1024, 1024, 0, 0, 0, 0,
  # [
  #     (store_script_param, ":banner_mesh", 1),
  #     (set_fixed_point_multiplier, 100),
  #     (store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
  ...
  #     (cur_tableau_set_background_color, ":background_color"),
  #     (init_position, pos1),
  #     (cur_tableau_add_mesh_with_vertex_color, "mesh_white_bg_plane_a", pos1, 200, 100, ":background_color"),
  #     (init_position, pos1),
  #     (position_set_x, pos1, 36),
  #     (position_set_y, pos1, 104),
  #     (cur_tableau_add_mesh, ":banner_mesh", pos1, 135, 0),
  #     (init_position, pos1),
  #     (position_set_z, pos1, 10),
  #     (cur_tableau_add_mesh, "mesh_tableau_mesh_sclavenia_round_shield_2", pos1, 0, 0),
  #     (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
  #     ]),

  #("concave_shield_tableau", 0, "concave_shield_leather", 1024, 1024, 0, 0, 0, 0,
  # [
  #     (store_script_param, ":banner_mesh", 1),
  #     (set_fixed_point_multiplier, 100),
  #     (init_position, pos1),
  #     (position_set_x, pos1, -44),
  #     (position_set_y, pos1, 172.5),
  #     (cur_tableau_add_mesh, ":banner_mesh", pos1, 125, 0),
  #     (init_position, pos1),
  #     (position_set_z, pos1, 20),
  #     (cur_tableau_add_mesh, "mesh_tableau_mesh_concave_shield_tableau", pos1, 0, 0),
  #     (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
  #]),

  ("round_shields_tableau_color", 0, "round_shields_leather_1", 1024, 1024, 0, 0, 0, 0,
   [
    (store_script_param, ":banner_mesh", 1),
    ...
    (position_set_z, pos1, 10),
    (val_div, ":banner_mesh", 1000),
    (val_add, ":banner_mesh", "mesh_tableau_mesh_round_shields"),
    (assign, reg3, ":banner_mesh"),
    (cur_tableau_add_mesh, ":banner_mesh", pos1, 0, 0),
    (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),

  ("concave_shield_tableau", 0, "round_shields_leather_1", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_x, pos1, -51.7),
       (position_set_y, pos1, 179),
       (cur_tableau_add_mesh, ":banner_mesh", pos1, 125, 0),
       (init_position, pos1),
       (position_set_z, pos1, 20),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_round_shields", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
  ]),

  ("round_shield_tabular", 0, "round_shields_leather_1", 1024, 1024, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
    ...
    ("wicker_shield", 0, "wicker_shields_1", 1024, 1024, 0, 0, 0, 0,
   [
    (store_script_param, ":banner_mesh", 1),
    ...
    (position_set_z, pos1, 10),
    (val_div, ":banner_mesh", 1000),
    (val_add, ":banner_mesh", "mesh_tableau_mesh_wickershield"),
    (assign, reg3, ":banner_mesh"),
    (cur_tableau_add_mesh, ":banner_mesh", pos1, 0, 0),
    (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
