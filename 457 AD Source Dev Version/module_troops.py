...
# mordvins
  ["knight_35_1", "Kanakon", "Kanakon", tf_hero, 0, reserved,  fac_kingdom_35, [itm_simple_shoes, itm_tetraxitae_spatha, itm_suvorovsky_helmet_mail, itm_common_mail_long_5_cloak, itm_tunic_10, itm_tab_shield_small_round_c, itm_sporoi_hun_horse_2],     knight_attrib_5,wp(300),knight_skills_5|knows_trainer_2, 0x0000000a9810118b1b117268a325a75b00000000001e76dc0000000000000000],
  ["knight_35_2", "Somajen", "Somajen", tf_hero, 0, reserved,  fac_kingdom_35,[itm_simple_shoes, itm_sword_viking_3_small, itm_tyum_helmet_2, itm_common_mail_short_7_cloak, itm_tunic_rich_5, itm_tab_shield_small_round_c, itm_sporoi_hun_horse_3],knight_attrib_5,wp(280),knight_skills_3,0x000000071800244c159b8cb493b6b91c00000000001cd6e40000000000000000],
...
#madsci rebel kingdom ladies will be disabled at start
  ...
  ["kingdom_35_lady_1","Kara","Kara",tf_hero|tf_female|tf_unmoveable_in_party_window,0,reserved,fac_kingdom_35, [      itm_germanic_dress_low_6,       itm_wrapping_boots],     def_attrib|level(2),wp(50),knows_common|knows_riding_2, 0x00000007ef0010043adb923d7491b8db00000000001dc6d40000000000000000],
  ["kingdom_35_lady_2","Yaga","Yaga",tf_hero|tf_female|tf_unmoveable_in_party_window,0,reserved,fac_kingdom_35, [      itm_germanic_dress_low_6,       itm_wrapping_boots],     def_attrib|level(2),wp(50),knows_common|knows_riding_2, 0x00000007ef0010043adb923d7491b8db00000000001dc6d40000000000000000],
  ["kingdom_35_lady_3","Kizor","Kizor",tf_hero|tf_female|tf_unmoveable_in_party_window,0,reserved,fac_kingdom_35, [      itm_germanic_dress_low_6,       itm_wrapping_boots],     def_attrib|level(2),wp(50),knows_common|knows_riding_2, 0x00000007ef0010043adb923d7491b8db00000000001dc6d40000000000000000],
  ["kingdom_35_lady_4","Ichak","Ichak",tf_hero|tf_female|tf_unmoveable_in_party_window,0,reserved,fac_kingdom_35, [      itm_germanic_dress_low_6,       itm_wrapping_boots],     def_attrib|level(2),wp(50),knows_common|knows_riding_2, 0x00000007ef0010043adb923d7491b8db00000000001dc6d40000000000000000],
...
#Seneschals
  ...
  ["town_48_seneschal", "{!}Town 48 Seneschal", "{!}Town 48 Seneschal", tf_hero|tf_is_merchant, 0,reserved,  fac_neutral,[ itm_roman_peasant_tunic_1,      itm_wrapping_boots],     def_attrib|level(2),wp(20),knows_common, 0x000000000004728b01c293c694944b05],
  ["town_49_seneschal", "{!}Town 49 Seneschal", "{!}Town 49 Seneschal", tf_hero|tf_is_merchant, 0,reserved,  fac_neutral,[ itm_roman_peasant_tunic_1,      itm_wrapping_boots],     def_attrib|level(2),wp(20),knows_common, 0x000000000004728b01c293c694944b05],
  ["town_50_seneschal", "{!}Town 50 Seneschal", "{!}Town 49 Seneschal", tf_hero|tf_is_merchant, 0,reserved,  fac_neutral,[ itm_berber_tunic_1,      itm_wrapping_boots],     def_attrib|level(2),wp(20),knows_common, 0x000000000004728b01c293c694944b05],
  ...
  ["castle_120_seneschal", "{!}Castle 4 Seneschal", "{!}Castle 4 Seneschal", tf_hero|tf_is_merchant, 0,reserved,  fac_neutral,[itm_roman_peasant_tunic_1,           itm_wrapping_boots],   def_attrib|level(2),wp(20),knows_common, 0x000000000004715201ea236c60a2bcae],
...
#Arena Masters
  ...
  ["town_50_arena_master", "Tournament Master","{!}Tournament Master",tf_hero|tf_randomize_face, scn_town_49_arena|entry(52),reserved,   fac_commoners,[itm_berber_tunic_1, itm_wrapping_boots],   def_attrib|level(2),wp(20),knows_common,man_face_1, man_face_2],
# Armor Merchants
  ...
  ["town_50_armorer","Armorer",  "{!}Armorer",  tf_hero|tf_randomize_face|          tf_is_merchant, 0, 0, fac_commoners,[itm_coptic_tunic_4,           itm_ankle_boots ],def_attrib|level(2),wp(20),knows_inventory_management_10, man_face_1, man_face_2],
# Weapon merchants
  ...
  ["town_50_weaponsmith", "Weaponsmith","{!}Weaponsmith",tf_hero|tf_randomize_face|tf_is_merchant, 0, 0, fac_commoners,[itm_berber_tunic_1,itm_wrapping_boots,itm_woolen_cap_1],def_attrib|level(2),wp(20),knows_inventory_management_10, man_face_1, man_face_2],
#Tavern keepers
  ...
  ["town_50_tavernkeeper", "Tavern_Keeper","{!}Tavern_Keeper",tf_hero|tf_randomize_face,           scn_town_49_tavern|entry(9),0,   fac_commoners,[itm_sarranid_cloth_robe,itm_wrapping_boots,itm_woolen_cap_3],def_attrib|level(2),wp(20),knows_common, mauri_face_1, mauri_face_2],
...
#Goods Merchants
  ...
  ["town_50_merchant", "Merchant", "{!}Merchant",          tf_hero|tf_randomize_face|tf_is_merchant, scn_town_49_store|entry(9),0, fac_commoners,     [itm_tunic_rich_4, itm_ankle_boots                  ],def_attrib|level(2),wp(20),knows_inventory_management_10, mauri_face_1, mauri_face_2],
...
# Horse Merchants
  ...
  ["town_50_horse_merchant","Horse Merchant","{!}Town 50 Horse Merchant",tf_hero|tf_randomize_face|tf_is_merchant|tf_female,    0, 0, fac_commoners,[itm_berber_tunic_1, itm_wrapping_boots, itm_woolen_hood],   def_attrib|level(5),wp(20),knows_inventory_management_10, mauri_face_1, mauri_face_2],
  ...
  ["town_50_mayor", "Guild_Master", "{!}Guild_Master", tf_hero|tf_randomize_face, 0,reserved,  fac_neutral,[itm_berber_tunic_1, itm_deurne_campagi_1,itm_pannonian_cap_2],     def_attrib|level(2),wp(20),knows_common,  mauri_face_1, mauri_face_2],
...
#Village stores
  ...
  ["village_304_elder","Village_Elder", "{!}village_1_elder",tf_hero|tf_randomize_face|tf_is_merchant, 0,0, fac_commoners,[itm_robe, itm_wrapping_boots],def_attrib|level(2),wp(20),knows_inventory_management_10,                              mauri_face_1, mauri_face_2],
  ["village_305_elder","Village_Elder", "{!}village_1_elder",tf_hero|tf_randomize_face|tf_is_merchant, 0,0, fac_commoners,[itm_robe, itm_wrapping_boots],def_attrib|level(2),wp(20),knows_inventory_management_10,                              mauri_face_1, mauri_face_2],
  ["village_306_elder","Village_Elder", "{!}village_1_elder",tf_hero|tf_randomize_face|tf_is_merchant, 0,0, fac_commoners,[itm_robe, itm_wrapping_boots],def_attrib|level(2),wp(20),knows_inventory_management_10,                              mauri_face_1, mauri_face_2],
  ["village_307_elder","Village_Elder", "{!}village_1_elder",tf_hero|tf_randomize_face|tf_is_merchant, 0,0, fac_commoners,[itm_robe, itm_wrapping_boots],def_attrib|level(2),wp(20),knows_inventory_management_10,                              mauri_face_1, mauri_face_2],
  ["village_308_elder","Village_Elder", "{!}village_1_elder",tf_hero|tf_randomize_face|tf_is_merchant, 0,0, fac_commoners,[itm_robe, itm_wrapping_boots],def_attrib|level(2),wp(20),knows_inventory_management_10,                              mauri_face_1, mauri_face_2],
...
# Place extra merchants before this point
  ...
  ["town_47_master_craftsman", "{!}Town 47 Craftsman", "{!}Town  47 Seneschal", tf_hero|tf_is_merchant, 0,reserved,  fac_neutral,[ itm_leather_apron,      itm_wrapping_boots],     def_attrib|level(2),wp(20),knows_common, 0x000000001104449136e44cbd1c9352bc000000000005e8d10000000000000000],
  ["town_48_master_craftsman", "{!}Town 48 Craftsman", "{!}Town 48 Seneschal", tf_hero|tf_is_merchant, 0,reserved,  fac_neutral,[ itm_leather_apron,      itm_wrapping_boots],     def_attrib|level(2),wp(20),knows_common, 0x000000001104449136e44cbd1c9352bc000000000005e8d10000000000000000],
  ["town_49_master_craftsman", "{!}Town 49 Craftsman", "{!}Town 49 Seneschal", tf_hero|tf_is_merchant, 0,reserved,  fac_neutral,[ itm_leather_apron,      itm_wrapping_boots],     def_attrib|level(2),wp(20),knows_common, 0x000000001104449136e44cbd1c9352bc000000000005e8d10000000000000000],
  ["town_50_master_craftsman", "{!}Town 50 Craftsman", "{!}Town 50 Seneschal", tf_hero|tf_is_merchant, 0,reserved,  fac_neutral,[ itm_leather_apron,      itm_wrapping_boots],     def_attrib|level(2),wp(20),knows_common, 0x000000001104449136e44cbd1c9352bc000000000005e8d10000000000000000],
...
#indigenoi fake nobles
  ...
  # == MACENITE (romano-berber) lords, knights & family members ==
  ["indigenoi_macenites_king", "Ait Macen","Ait Macen", tf_hero, 0, 0, fac_indigenoi, [itm_barb_cham_1,itm_sassanid_cavalry_boots_2,itm_common_mail_short_2,itm_burgh_helmet_1,itm_turban,itm_strong_hammer,itm_simple_shoes,itm_tunic_rich_7],
   def_attrib_lvl_13|level(13),wp_one_handed(210)|wp_polearm(100)|wp_firearm(150),knows_lvl_13|knows_power_strike_4,0x0000000f210134c04b0a8bcd75e6c72d00000000001d28a50000000000000000],
  ["indigenoi_macenites_lady_1", "Taklit tin Tafouk","Taklit tin Tafouk", tf_hero|tf_female|tf_unmoveable_in_party_window, 0, reserved, fac_indigenoi,  [itm_sarranid_lady_dress,       itm_wrapping_boots], def_attrib|level(2),wp(50),knows_common|knows_riding_2, 0x00000007b6002004252d524cd925c89b00000000001d569d0000000000000000], # kings mother
  ...
  ["indigenoi_macenites_noble_1","Marcus Sammac Chullamensis","Marcus Sammac", tf_hero, 0, 0, fac_indigenoi, [itm_barb_cham_1,itm_sassanid_cavalry_boots_2,itm_common_mail_short_2,itm_burgh_helmet_1,itm_turban,itm_strong_hammer,itm_simple_shoes,itm_tunic_rich_7],
   def_attrib_lvl_13|level(13),wp_one_handed(210)|wp_polearm(100)|wp_firearm(150),knows_lvl_13|knows_power_strike_4,0x000000001c0064d0295bb1e29e3638de00000000000b35120000000000000000],
  ...
  ["indigenoi_macenites_noble_2", "Ait Baquates", "Ait Baquates",tf_hero,0,0,fac_indigenoi,   [itm_barb_cham_1,itm_sassanid_cavalry_boots_2,itm_common_mail_short_2,itm_burgh_helmet_1,itm_turban,itm_strong_hammer,itm_simple_shoes,itm_tunic_rich_7],
   def_attrib_lvl_13|level(13),wp_one_handed(210)|wp_polearm(100)|wp_firearm(150),knows_lvl_13|knows_power_strike_4,0x000000001c01350648cc79b7146ac51c00000000001216640000000000000000],
  ...
  ["indigenoi_macenites_lady_8", "Tafoukt tan Melil", "Tafoukt tan Melil", tf_hero|tf_female|tf_unmoveable_in_party_window, 0, reserved, fac_indigenoi, [itm_sarranid_lady_dress_b,      itm_wrapping_boots],     def_attrib|level(2),wp(50),knows_common|knows_riding_2,   0x00000003bf0010061b5cb5d8ed75b4db00000000001e271c0000000000000000], # lords wife
  ["indigenoi_macenites_lady_9", "Azelma tam Ghasen", "Azelma tam Ghasen",tf_hero|tf_female|tf_unmoveable_in_party_window, 0, reserved, fac_indigenoi, [itm_sarranid_lady_dress_b,      itm_wrapping_boots],     def_attrib|level(2),wp(50),knows_common|knows_riding_2,   0x00000003bf0010061b5cb5d8ed75b4db00000000001e271c0000000000000000], # lords sister
