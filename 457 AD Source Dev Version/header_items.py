...
#removed |itcf_thrust_onehanded_lance_horseback from spears + lances, will be used for two handed thrusts | itcf_thrust_onehanded_lance
...
itc_staff      = itc_parry_polearm|itcf_thrust_onehanded_lance_horseback| itcf_thrust_onehanded_lance | itcf_overswing_polearm |itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm
itc_spear      = itc_parry_polearm|itcf_thrust_onehanded_lance_horseback| itcf_thrust_onehanded_lance | itcf_thrust_polearm
...
itc_spear_upstab = itc_parry_polearm|itcf_thrust_onehanded |itcf_overswing_musket |itcf_thrust_onehanded_lance_horseback |itcf_overswing_spear|itcf_thrust_polearm |itcf_slashleft_polearm|itcf_slashright_polearm
itc_lance_upstab = itc_parry_polearm|itcf_thrust_onehanded |itcf_overswing_musket |itcf_thrust_onehanded_lance_horseback |itcf_overswing_spear|itcf_thrust_polearm |itcf_slashleft_polearm|itcf_slashright_polearm
#itc_spear_upstab =  itc_spear|itcf_force_64_bits|itcf_overswing_spear|itcf_overswing_musket|itcf_slashleft_polearm|itcf_slashright_polearm #old
#itc_lance_upstab =  itc_spear|itcf_force_64_bits|itcf_overswing_spear|itcf_overswing_musket|itcf_slashleft_polearm|itcf_slashright_polearm
itc_greatlance_upstab =  itc_greatlance|itcf_force_64_bits|itcf_overswing_spear|itcf_overswing_musket
itc_pike_upstab = itc_parry_polearm|itcf_force_64_bits|itcf_overswing_spear|itcf_thrust_polearm
#used for kontos
#itc_kontos_upstab =  itc_spear|itcf_force_64_bits|itcf_overswing_spear|itcf_thrust_onehanded_lance_horseback|itcf_overswing_musket|itcf_slashleft_polearm|itcf_slashright_polearm
itc_kontos_upstab = itc_parry_polearm|itcf_thrust_onehanded_lance_horseback|itcf_thrust_musket|itcf_thrust_onehanded_lance|itcf_slashleft_polearm|itcf_slashright_polearm|itcf_overswing_spear
