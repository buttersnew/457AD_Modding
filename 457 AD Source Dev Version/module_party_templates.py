...
("slavic_bandits","Slavic Bandits",icon_sea_raider|carries_goods(8),0,fac_outlaws,bandit_personality,[(trp_slavic_bandit,15,40)]), 
  ...
  ("quest_bagaudae","Bagaudae",icon_sea_raider|carries_goods(9)|pf_auto_remove_in_town|pf_quest_party,0,fac_forest_bandits,bandit_personality,[(trp_forest_bandit,30,40),(trp_forest_bandit_recruit,15,20),(trp_bagaudae_footman,15,25)]), #less than normal
