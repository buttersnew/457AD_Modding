...
#  [35.0, "tavern_stand", 0, 472, arf_cyclic|arf_loop_pos_0_25],
 ...
 ["stand_man", 0, amf_client_prediction,
    [9.0, "new_stand_man", 0, 314, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
...
##   [0.8, "jump_end_hard", 29, 54, arf_blend_in_1],
 ...
 ["stand_single", 0, amf_client_prediction,
   ...
   [9.0, "sword_loop03_new", 0, 59, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   [9.0, "sword_loop04", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
   #[9.0, "stand_two_handed_new", 0, 139, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_greatsword", 0, amf_client_prediction,
   [12.0, "twohanded_01", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
   [8.0, "twohanded_02", 0, 200, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
   [12.0, "twohanded_03", 0, 100, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
   [10.0, "pike_loop01", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
   [9.0, "stand_two_handed_new", 0, 139, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_staff", 0, amf_client_prediction,
   #[2.0, "staff_cstance", 0, 60, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.0],  
   [10.0, "pike_loop01", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],  
   [10.0, "pike_loop02", 0, 99, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25], 
 ],
...
#   [0.8, "run_normal", 0, 12, arf_use_walk_progress|arf_cyclic|blend_in_walk,pack2f(0.4,0.9)], 
   ...
   [0.8, "rg_run_sword_2", 0, 23, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   ...
   [0.8, "rg_run_pike_1", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
   [0.8, "rg_run_pike_2", 0, 24, arf_use_walk_progress|arf_cyclic|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4], 
 ],
...
#   [1.0, "anim_human", 7040, 7000, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   ...
   [0.7, "run_backward_new", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
   [0.7, "run_backward", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
   #[0.7, "run_man_backward_onehanded", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
 ],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [0.7, "run_backward_staff_new", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [0.7, "run_backward_staff_right_new", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
...
#   [1.0, "anim_human", 7140, 7100, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.0],
   [0.7, "run_backward_staff_left_new", 0, 21, arf_use_inv_walk_progress|arf_cyclic|blend_in_walk|arf_make_walk_sound,pack2f(0.4,0.9), (0, 0, 0), 0.4],
...
##   [0.8, "anim_human", horse_move+210, horse_move+250, arf_cyclic |  arf_blend_in_16],
 ...
 ["ride_4", acf_enforce_lowerbody | acf_synch_with_horse, amf_client_prediction,
   ...
   #[0.5, "newanim_ride_4", 0, 15, arf_cyclic|arf_blend_in_32],
   #[0.5, "mounted_pose_uniA", 0, 49, arf_cyclic|arf_blend_in_32], 
   #[0.5, "mounted_pose_lance", 0, 49, arf_cyclic|arf_blend_in_32], 
   #[0.5, "mounted_pose_fist", 0, 49, arf_cyclic|arf_blend_in_32], 
 ],
...
# ],
 ["lancer_ride_4",  acf_enforce_lowerbody | acf_synch_with_horse | acf_rot_vertical_sword|acf_anim_length(30), amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play,
   [0.5, "lancer_armslength", 0, 15, arf_cyclic | arf_blend_in_128], 
 ],
 ["lancer_ride_4_no_shield",  acf_enforce_lowerbody | acf_synch_with_horse | acf_rot_vertical_sword|acf_anim_length(30), amf_rider_rot_couched_lance|amf_client_prediction|amf_priority_ride|amf_play,
   [0.5, "kontos_lance", 15, 15, arf_cyclic | arf_blend_in_128], 
 ],
...
#   [1.5, "anim_human", combat+500, combat+530, blend_in_ready|arf_make_custom_sound, pack2f(0.14, 0.44)],
   ...
   [1.5, "thumbdraw", 0, 164, blend_in_ready|arf_make_custom_sound, pack2f(0.14, 0.44)],
 ],
...
#   [0.3, "anim_human", combat+530, combat+532, arf_blend_in_2],
   ...
   [0.2, "thumbdraw", 165, 166, arf_blend_in_2],
 ],
 #not used
...
##   [1.0, "throw_stone", 21, 54, arf_blend_in_0],
 ...
 # ["ready_pistol", acf_rot_vertical_bow, amf_priority_attack|amf_keep|amf_use_cycle_period|amf_client_owner_prediction|amf_rider_rot_throw,
 #  [0.9, "wb_sling_animation", 0, 10, arf_cyclic|blend_in_ready],
 #],
 #["release_pistol", acf_rot_vertical_bow, amf_priority_defend_parry|amf_rider_rot_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction,
 #  [0.8, "throwing_stone", 25, 60, arf_blend_in_0],
 #],
 #["reload_pistol", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
 #  [1.0, "anim_human", combat+1700, combat+1750, arf_blend_in_8], 
 #],
 ["ready_pistol", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_pistol,
   [0.4, "throwing_slinge_20_35", 0, 15, blend_in_ready|arf_cyclic|arf_make_custom_sound, pack2f(0.14, 0.44)],
 ],
 ["release_pistol", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_throw|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_pistol,
   [0.9, "throw_slinge", 34, 60, arf_blend_in_0|arf_make_custom_sound, pack2f(0.14, 0.44)],
 ],
 ["reload_pistol", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
   [0.8, "throw_slinge", 80, 115, arf_blend_in_8|arf_make_custom_sound, pack2f(0.10, 0.40)], 
 ],
...
##   [ready_durn, "anim_human", combat+8500, combat+8510, blend_in_ready], 
   ...
   [ready_durn, "rg_spear_1h_thrust", 0, 5, blend_in_ready], 
 ],
...
##   [0.61, "anim_human", combat+8510, combat+8540, blend_in_release], 
   #[0.46, "attacks_thrust_onehanded", 12, 32, blend_in_release], 
   #[0.45, "1h_low_thrust_30.9.10", 5, 34, blend_in_release],
   [0.62, "rg_spear_1h_thrust", 5, 34, blend_in_release],
 ],
 ["release_thrust_onehanded_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_rider_rot_thrust|amf_client_owner_prediction,
   ...
   [0.35, "rg_spear_1h_thrust", 34, 39, blend_in_continue],
 ],
...
##   [0.9, "attacks_thrust_onehanded", 16, 54, blend_in_release], 
   #[0.50, "attacks_thrust_onehanded", 12, 32, blend_in_release], 
   [0.45, "1h_low_thrust_30.9.10", 5, 34, blend_in_release],
 ],
...
##   [0.1, "attacks_thrust_onehanded", 54, 54, blend_in_continue], 
   #[0.26, "attacks_thrust_onehanded", 32, 54, blend_in_continue], 
   [0.3, "1h_low_thrust_30.9.10", 34, 39, blend_in_continue],
 ],
...
##   [ready_durn, "anim_human", combat+9500, combat+9508, blend_in_ready], 
   #[ready_durn, "thrust_onehanded_lance_hb", 5, 8, blend_in_ready], #new thrusting animation 6/18/20
...
##   [0.62, "anim_human", combat+9507, combat+9530, blend_in_release], 
   #[0.50, "thrust_onehanded_lance_hb", 8, 33, blend_in_release], 
   #[0.45, "attacks_staff_thrust", 21, 40, blend_in_release], 
   #[0.47, "1h_low_thrust_30.9.10", 5, 34, blend_in_release], 
   [0.65, "Polearm_thrust_3.10.10", 5, 32, blend_in_release], 
 ],
...
#   [defend_keep_duration, "anim_human", defend+118, defend+120, arf_blend_in_4|arf_cyclic], 
   [defend_keep_duration, "shield_anim_new", 6, 6, arf_blend_in_4|arf_cyclic],  
 ],
 ["defend_shield_parry_1", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   ...
   [defend_parry_duration_1, "shield_anim_new", 7, 9, arf_blend_in_1], 
 ],
 ["defend_shield_parry_2", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   ...
   [defend_parry_duration_2, "shield_anim_new", 7, 9, arf_blend_in_1],
 ],
 ["defend_shield_parry_3", acf_parallels_for_look_slope|acf_anim_length(100), amf_priority_defend_parry|amf_play|amf_restart|amf_rider_rot_shield,
   ...
   [defend_parry_duration_3, "shield_anim_new", 7, 9, arf_blend_in_1],
 ],
...
#   [0.6,  "anim_human", blow+5200, blow+5220, arf_blend_in_3], 
 ...
 ["fall_chest_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [1.0, "new_death_3", 0, 37, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0.0), (0,0,0), 0.7],
   [2.8, "new_death_7", 0, 194, arf_blend_in_16|arf_make_custom_sound, pack2f(0.4, 0.0), (0,0,0), 2.65],
   [1.0, "vyrn_chest", 0, 79, arf_blend_in_16|arf_make_custom_sound, pack2f(0.9, 0.0), (0,0,0), 0.5],
 ],
 ...
 ["fall_head_front", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [1.2, "death_head_7", 0, 59, arf_blend_in_16|arf_make_custom_sound, pack2f(0.8, 0.0), (0,0,0), 0.8], 
 ],
 ...
 ["fall_body_back", acf_enforce_all|acf_align_with_ground|acf_lock_camera, amf_priority_die|amf_accurate_body|amf_keep|amf_client_prediction,
   ...
   [2.7, "new_death_crawl", 0, 109, arf_blend_in_16|arf_make_custom_sound, pack2f(0.47, 0.82), (0,0,0), 1.8], 
   [2.7, "mm_death_2", 0, 54, arf_blend_in_16|arf_make_custom_sound, pack2f(0.47, 0.82), (0,0,0), 1.8], 
   [2.8, "new_death_7", 0, 194, arf_blend_in_16|arf_make_custom_sound, pack2f(0.4, 0.0), (0,0,0), 2.65],
 ],
...
##   [3.0, "anim_human", 70100, 70150, arf_blend_in_5],
 ...
 ["stand_townguard", 0, 0,
  ...
  [4.0, "new_stand_man", 0, 314, arf_use_stand_progress|arf_cyclic, 0, (0, 0, 0), 0.25],
 ],
 ["stand_lady", 0, 0,
...
#   [10.0, "anim_human_temp", 0, 10, arf_blend_in_5], 
 ...
 ["crouch_ready_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_rider_rot_pistol,
   [0.3, "anim_human", 1, 12, blend_in_ready],
 ],
 ["crouch_release_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_pistol,
   [0.3, "anim_human", 12, 21, arf_blend_in_1],
 ],
...
["ready_overswing_musket", acf_rot_vertical_sword| acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_use_inertia|amf_keep|amf_client_owner_prediction|amf_rider_rot_thrust,
  ...
  [ready_durn, "1h_spear_thrust_overhead", 0, 18, blend_in_ready],
  #[ready_durn, "rg_cifre_spear_overhead", 15, 24, blend_in_ready], 
],
["release_overswing_musket", acf_rot_vertical_sword|acf_overswing, amf_priority_attack|amf_use_weapon_speed|amf_play|amf_continue_to_next|amf_rider_rot_thrust,
  #[0.43, "1h_spear_thrust_overhead", 20, 41, blend_in_release],
  [0.3, "1h_spear_thrust_overhead", 19, 27, blend_in_release],
  #[0.60, "rg_cifre_spear_overhead", 23, 40, blend_in_release], 
],
["release_overswing_musket_continue", 0, amf_priority_continue|amf_use_weapon_speed|amf_play|amf_client_owner_prediction|amf_rider_rot_thrust,
  [0.3, "1h_spear_thrust_overhead", 28, 34, arf_blend_in_2],
  #[0.15, "rg_cifre_spear_overhead", 40, 50, blend_in_continue],
],
["parried_overswing_musket", 0, amf_priority_parried|amf_use_weapon_speed|amf_play,
  #[0.3, "1h_spear_thrust_overhead", 34, 27, blend_in_parry],
  [attack_blocked_duration_thrust, "anim_human", combat+8515, combat+8513, blend_in_parry], 
],
...
# ],
 ...
 ["equip_pistol_melee", 0, amf_priority_equip|amf_play|amf_restart|amf_client_prediction,
   ...
   [0.3, "anim_human", 0, 10, arf_blend_in_0],
 ],
 ...
 ["shield_taunt_1", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction, [0.9, "taunt", 0, 32, arf_blend_in_1]],
 ["horn", acf_enforce_all, amf_priority_kick|amf_play|amf_client_prediction, [1, "sayazn_battle_horn", 0, 131, arf_blend_in_1]],
